...
export default function PartyDetail() {
  ...
  const handlePreTxSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setTxError('');
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handlePreTxSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">{isPurchaseStyle && showTxModal === 'CREDIT' ? 'Bill No.' : 'Receipt / Invoice No.'}</label>
                <input type="text" value={txInvoiceNo} onChange={e => { setTxInvoiceNo(e.target.value.toLowerCase()); setTxError(''); }} className="w-full px-3 py-2 border rounded-md focus:border-sky-500 focus:ring-1 focus:ring-sky-500" />
              </div>
              <div>
